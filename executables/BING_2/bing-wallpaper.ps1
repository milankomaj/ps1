...
if(!($ErrorMessageFull.split(':')[2] -eq $null) -and !($ErrorMessageFull.split(':')[1] -eq $null) ) 
{$ErrorMessage = $ErrorMessageFull.split(':')[2].split([IO.Path]::GetInvalidFileNameChars()) -join ''} 
elseif(!($ErrorMessageFull.split(':')[1] -eq $null) -and !($ErrorMessageFull.split(':')[0] -eq $null) )
{$ErrorMessage = $ErrorMessageFull.split(':')[1].split([IO.Path]::GetInvalidFileNameChars()) -join ''} 
elseif(!($ErrorMessageFull.split("''")[1] -eq $null))
{$ErrorMessage = $ErrorMessageFull.split("''")[1].split([IO.Path]::GetInvalidFileNameChars()) -join ''}
